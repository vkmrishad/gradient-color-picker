...
(function() {
    // append lgcolor html
    var elem = '<div class="lg-row lg-white" style="display:none;"> <div class="lg-col m12" id="main"> <div class="lg-container lg-padding-large" style="background-color:#f1f1f1;border:1px solid #d3d3d3;"> <div class="lg-row"> <div class="lg-col m6"> <div id="result01"></div><br></div><div class="lg-col m1">&nbsp;</div><div class="lg-col m5"> <div style="font-family:Consolas, \'courier new\';padding-bottom:8px;"> <input id="color1" class="jscolor{uppercase:false, hash:true}" type="text" class="lg-input lg-border" onchange="setGradient()" onkeydown="submitOnEnter(event)" value="#00f260" style="width: 130px;height: 25px;"> <div style="height:5px"></div><input id="color2" class="jscolor{uppercase:false, hash:true}" type="text" class="lg-input lg-border" onchange="setGradient()" onkeydown="submitOnEnter(event)" value="#0575e6" style="width: 130px;height: 25px;"> </div><div class="lg-col s3 directionbtn"><div id="dir1" onclick="setGradient(\'bottom\')"></div></div><div class="lg-col s3 directionbtn"><div id="dir2" onclick="setGradient(\'right\')"></div></div><div class="lg-col s3 directionbtn"><div id="dir3" onclick="setGradient(\'top left\')"></div></div><div class="lg-col s3 directionbtn"><div id="dir4" onclick="setGradient(\'top right\')"></div></div><div class="lg-col s3 directionbtn"><div id="dir5" onclick="setGradient(\'top\')"></div></div><div class="lg-col s3 directionbtn"><div id="dir6" onclick="setGradient(\'left\')"></div></div><div class="lg-col s3 directionbtn"><div id="dir7" onclick="setGradient(\'bottom left\')"></div></div><div class="lg-col s3 directionbtn"><div id="dir8" onclick="setGradient(\'bottom right\')"></div></div></div></div><div class="lg-row" style="height: 70px;"><div class="lg-col m2" style="font-family:Consolas, \'courier new\';"> <div id="touchbutton1" style="text-align:center;display:none;"> <button ontouchstart="touchslider(1, -1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(1, -1, event)" onmouseup="stoptouchslider()">&#10094;</button> <button ontouchstart="touchslider(1, 1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(1, 1, event)" onmouseup="stoptouchslider()">&#10095;</button> </div><input class="lg-input lg-border" type="number" style="padding:3px 5px;margin:auto;width: 85%;float: left;" id="pow1" oninput="setGradient()" onchange="setGradient()" value="0"><br class="lg-hide-medium lg-hide-large"></div><div class="lg-col m8" style="position:relative;"> <div id="shield"></div><div id="redtable"></div></div><div class="lg-col m2" style="font-family:Consolas, \'courier new\';"> <br class="lg-hide-medium lg-hide-large"> <input class="lg-input lg-border" type="number" style="padding:3px 5px;margin:auto;width: 85%;float: right;" id="pow2" oninput="setGradient()" onchange="setGradient()" value="100"> <div id="touchbutton2" style="display:none;text-align:center;"> <button ontouchstart="touchslider(2, -1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(2, -1, event)" onmouseup="stoptouchslider()">&#10094;</button> <button ontouchstart="touchslider(2, 1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(2, 1, event)" onmouseup="stoptouchslider()">&#10095;</button> </div></div></div><div class="lg-row"><div class="lg-col l12 m12 lg-center" style="font-family:Consolas, \'courier new\';"> <input type="hidden" id="gradientinput" name="gradientinput" value=""> <button class="lg-button lg-close">Close</button> <button class="lg-button lg-apply">Apply</button> <br class="lg-hide-medium lg-hide-large"></div></div></div></div></div>';
